	...
	return (
		<>
			<div className="items-center flex-row flex justify-between h-20">
				...
				>
					<Link className={`px-6 hover:underline underline-offset-4 ${pathName === '/' ? 'underline' : ''}`} href={"/"}>
						Home
					</Link>
					<Link className={`px-6 hover:underline underline-offset-4 ${pathName === '/about' ? 'underline' : ''}`} href={"/about"}>
						About
					</Link>
					<Link className={`px-6 hover:underline underline-offset-4 ${pathName === '/portfolio' ? 'underline' : ''}`} href={"/portfolio"}>
						Portfolio
					</Link>
					<Link className={`px-6 hover:underline underline-offset-4 ${pathName === '/blog' ? 'underline' : ''}`} href={"/blog"}>
						Blog
					</Link>
